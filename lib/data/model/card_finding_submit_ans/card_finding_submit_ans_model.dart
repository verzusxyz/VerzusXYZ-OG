...
CardFindingSubmitAnsModel CardFindingSubmitAnsModelFromJson(String str) =>
    CardFindingSubmitAnsModel.fromJson(json.decode(str));

String CardFindingSubmitAnsModelToJson(CardFindingSubmitAnsModel data) =>
...
class CardFindingSubmitAnsModel {
  ...
  factory CardFindingSubmitAnsModel.fromJson(Map<String, dynamic> json) =>
      CardFindingSubmitAnsModel(
        remark: json["remark"],
        status: json["status"],
