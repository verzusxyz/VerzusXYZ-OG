...
HeadTailInvestmentResponseModel headTailSubmitAnsModelFromJson(String str) =>
    HeadTailInvestmentResponseModel.fromJson(json.decode(str));

String headTailSubmitAnsModelToJson(HeadTailInvestmentResponseModel data) =>
...
class HeadTailInvestmentResponseModel {
  ...
  factory HeadTailInvestmentResponseModel.fromJson(Map<String, dynamic> json) =>
      HeadTailInvestmentResponseModel(
        remark: json["remark"],
        status: json["status"],
