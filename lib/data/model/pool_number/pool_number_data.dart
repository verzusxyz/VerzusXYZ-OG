...
PoolNumberDataModel PoolNumberDataModelFromJson(String str) =>
    PoolNumberDataModel.fromJson(json.decode(str));

String PoolNumberDataModelToJson(PoolNumberDataModel data) =>
...
class PoolNumberDataModel {
  ...
  PoolNumberDataModel({this.remark, this.status, this.message, this.data});

  factory PoolNumberDataModel.fromJson(Map<String, dynamic> json) =>
      PoolNumberDataModel(
        remark: json["remark"],
        status: json["status"],
