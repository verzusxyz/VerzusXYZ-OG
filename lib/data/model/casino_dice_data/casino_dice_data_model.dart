...
CasinoDiceDataModel CasinoDiceDataModelFromJson(String str) =>
    CasinoDiceDataModel.fromJson(json.decode(str));

String CasinoDiceDataModelToJson(CasinoDiceDataModel data) =>
...
class CasinoDiceDataModel {
  ...
  CasinoDiceDataModel({this.remark, this.status, this.message, this.data});

  factory CasinoDiceDataModel.fromJson(Map<String, dynamic> json) =>
      CasinoDiceDataModel(
        remark: json["remark"],
        status: json["status"],
