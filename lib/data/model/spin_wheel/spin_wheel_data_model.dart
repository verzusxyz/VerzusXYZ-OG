...
SpinWheelDataModel spinWheelDataModelFromJson(String str) =>
    SpinWheelDataModel.fromJson(json.decode(str));

String spinWheelDataModelToJson(SpinWheelDataModel data) =>
...
class SpinWheelDataModel {
  ...
  SpinWheelDataModel({this.remark, this.status, this.message, this.data});

  factory SpinWheelDataModel.fromJson(Map<String, dynamic> json) =>
      SpinWheelDataModel(
        remark: json["remark"],
        status: json["status"],
