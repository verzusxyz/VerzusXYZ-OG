...
SpinWheelResultModel spinWheelResultModelFromJson(String str) =>
    SpinWheelResultModel.fromJson(json.decode(str));

String spinWheelResultModelToJson(SpinWheelResultModel data) =>
...
class SpinWheelResultModel {
  ...
  SpinWheelResultModel({this.remark, this.status, this.message, this.data});

  factory SpinWheelResultModel.fromJson(Map<String, dynamic> json) =>
