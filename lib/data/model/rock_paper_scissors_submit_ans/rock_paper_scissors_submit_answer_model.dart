...
RockpaperScissorsSubmitAnswerModel rockpaperScissorsSubmitAnswerModelFromJson(
  String str,
) => RockpaperScissorsSubmitAnswerModel.fromJson(json.decode(str));

String rockpaperScissorsSubmitAnswerModelToJson(
  RockpaperScissorsSubmitAnswerModel data,
...
class RockpaperScissorsSubmitAnswerModel {
  ...
  factory RockpaperScissorsSubmitAnswerModel.fromJson(
